...
#             imgs = len(self.keys)
#             print('该画师有 %d 张插画/插画集'.center(50 // 2, '-') % imgs)
#         else:
#             print('该ID为普通用户ID哦')
#             os.rmdir(self.path)
#             exit()
...
import os
import sys
sys.path.append('C:/Users/Administrator/Desktop/python/pixiv/pixiv_vpn/')
# from python.pixiv.pixiv_vpn.download_Zip import ABC
